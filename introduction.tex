...
\section{Purpose}
This document presents the final project report for \textit{Prism AI Browser}, an intelligent, agentic, and privacy-centric web browser developed as part of the B.Tech final year project at the Department of Computer Science and Engineering, College of Engineering Karunagappally. The report describes the problem domain, the design and architecture of the system, its features, non-functional requirements, and UML-based system models.
